...
// optional per-vertex color multiplier
...
in vec3 LocalPos;
in vec2 TexCoord;
in vec4 ObjectColor; // used as albedo and opacity
in vec4 VertexColor;
...
void main()
{
    ...
    vec3 albedo_srgb = clamp(ObjectColor.rgb * VertexColor.rgb, 0.0, 1.0);
    float alpha = clamp(ObjectColor.a * VertexColor.a, 0.0, 1.0);
